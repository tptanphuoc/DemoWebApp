    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <c:forEach items="${listProductOfSeller}" var="p">
                    <tr>
                        <td>${p.id}</td>
                        <td><a href="detail?product-id=${p.id}">${p.name}</a></td>
                        <td>${p.title}</td>
                        <td><img src="${p.image}" class="avatar" alt="Avatar"></td>                        
                        <td>${dcf.format(p.price)}đ</td>
                        <td>${p.quantity}</td>
                        <td>
                            <a href="product-info?pid=${p.id}" data-toggle="tooltip" class="settings" title="Sửa sản phẩm"><i class="material-icons">&#xE8B8;</i></a>
                            <a href="deleteproduct?pid=${p.id}" class="delete" title="Xóa sản phẩm" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm: ${p.name}?')"><i class="material-icons">&#xE5C9;</i></a>
                        </td>
                    </tr>
                    </c:forEach>
                </tbody>
